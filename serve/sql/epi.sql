...
CREATE TABLE article(
    ...
    aimg VARCHAR(500) NOT NULL COMMENT '文章/视频封面图',
    aconment  VARCHAR(1000) NOT NULL COMMENT '文章正文/视频路径',
    atime    DATE NOT NULL COMMENT '文章/视频发布日期',
...
CREATE TABLE dynamic (
    ...
    likeCount INT NOT NULL DEFAULT '0' COMMENT '该条动态获取点赞的数量',
    FOREIGN KEY(uid) REFERENCES user(uid)
);
INSERT INTO dynamic VALUES (null,'今日疫情防护打卡','img/dynamic/1.jpg',1567382190,'1','0');
-- 用户点赞表
CREATE TABLE islike (
